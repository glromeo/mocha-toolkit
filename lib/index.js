...
exports.sinon = exports.chai = exports.fake = exports.mock = exports.stub = exports.spy = exports.match = exports.expect = exports.assert = exports.xit = exports.it = exports.afterEach = exports.after = exports.beforeEach = exports.before = exports.describe = void 0;
...
async function reimport(module, requireOptions = { paths: [callerDirname()] }) {
    ...
    return Promise.resolve(`${module}`).then(s => __importStar(require(s)));
}
function stacktrace() {
